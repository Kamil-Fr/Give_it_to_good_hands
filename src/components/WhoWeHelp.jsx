    ...
    return (
        <section id="whoWeHelp" className="whoWeHelp">
            ...
            <div className="switchWhoHelp">
                <button onClick={handleClickFirstOption} style={borderFirst}>Fundacjom</button>
                <button onClick={handleClickSecondOption} style={borderSecond}>Organizacjom<br/>pozarządowym</button>
                <button onClick={handleClickThirdOption} style={borderThird}>Lokalny<br/>zbiórkom</button>
            </div>
